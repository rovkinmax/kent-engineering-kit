...
Steer and the bounded grill child are exceptions only for their necessary
Session-state effects. Watch is read-only observation. They authorize no
other database, service, or user-data mutations.
